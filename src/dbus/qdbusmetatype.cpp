...
CS_DECLARE_METATYPE(QList<bool>)
CS_DECLARE_METATYPE(QList<short>)
CS_DECLARE_METATYPE(QList<ushort>)
CS_DECLARE_METATYPE(QList<uint>)
CS_DECLARE_METATYPE(QList<qint64>)
CS_DECLARE_METATYPE(QList<quint64>)
CS_DECLARE_METATYPE(QList<double>)
